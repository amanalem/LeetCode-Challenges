...
var isValidSudoku = function(board) {
    ...
    for (let i = 0; i < board.length; i++) {
        ...
        for (let j = 0; j < board.length - 1; j++) {
            ...
            //Check that each row has unique value
            if (row[j] !== ".") {
                
                let compValRow = row[j]
                
                for (let k = j + 1; k < board.length; k++) {
                    if (row[k] === compValRow) return false
                }
            }
            
            //Check colums are unique
            if (column[j] !== ".") {
                
                let compValCol = column[j]
                
                for (let k = j + 1; k < board.length; k++) {
                    if (column[k] === compValCol) return false
                }
            }
            
            //Check Boxes are unique
            if (box[j] !== ".") {
                
                let compValBox = box[j]
                
                for (let k = j + 1; k < board.length; k++) {
                    if (box[k] === compValBox) return false
                }
            }
